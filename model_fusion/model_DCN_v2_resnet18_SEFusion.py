...
from model.DCN_v2_resnet import DCN_BasicBlock
...
class FusionNet(nn.Module):
    ...
    def __init__(self, num_class=2):
        ...
        self.res_0 = self._make_layer(DCN_BasicBlock, 384, 256, 2, stride=2)
        self.res_1 = self._make_layer(DCN_BasicBlock, 256, 512, 2, stride=2)
